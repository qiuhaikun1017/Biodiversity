...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var otulabes = result1.otu_labels;
    ...
    var top10uids = otuids.slice(0,10);
    var top10uids1 = top10uids.map(i => "uid" + i);

    var top10lable = otulabes.slice(0,10);

    var top10samplevalues = samplevalues.slice(0,10);

    console.log(top10lable);
    ...
    var bubblecolor = top10uids.map(i => parseInt(i));
