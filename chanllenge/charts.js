...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var top10uids = otu_ids.slice(0,10);
    var top10uids1 = top10uids.map(i => "uid" + i);

    var top10lable = otu_labels.slice(0,10);

    var top10samplevalues = sample_values.slice(0,10);
    ...
    //// create variable that holds meta array and wfreq
